...
class ComicSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($comics as $comic) {
            ...
            $comi->thumb = $comic['thumb'];
            $comi->title = $comic['title'];
            $comi->type = $comic['type'];
            $comi->series = $comic['series'];
            $comi->sale_date = $comic['sale_date'];
            $comi->description = $comic['description'];
            $comi->price = $comic['price'];
